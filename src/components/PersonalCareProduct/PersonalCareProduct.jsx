...
function PersonalCareProduct() {
   ...
   const handleViewProductDetails = (productId) => {
    ...
    return(
        <section className="personal_care_product py-10 bg-white">
            <div className="container max-w-[1320px] mx-auto px-4">
                <div className="section_content_wrapper">
                    <div className="section_header text-center">
                        <h5 className="text-[17px] font-urbanist text-brown-600 uppercase tracking-widest">Fragrance Free</h5>
                        <h2 className="text-[45px] font-urbanist font-bold text-black leading-14 tracking-normal">Personal Care Products</h2>
                    </div>
